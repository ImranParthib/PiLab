                ...
                {!quizCompleted ? (
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden">
                        ...
                        <div className="p-6">
                            <div className="grid grid-cols-1 gap-4">
                                {questions[currentQuestion].options.map((option, index) => (
                                    <button
                                        ...
                                        className={`p-4 rounded-lg border-2 text-left transition-all ${selectedAnswer === option
                            ...
                            {showResult && (
                                <div className={`mt-6 p-4 rounded-lg ${selectedAnswer === questions[currentQuestion].correctAnswer
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div>
                                            <p className={`font-semibold ${selectedAnswer === questions[currentQuestion].correctAnswer
